# profiles/qwen3.5-35b-a3b.sh — Qwen 3.5 35B-A3B (Q4_K_M + vision)
#
...
FILES=("Qwen3.5-35B-A3B-Q4_K_M.gguf" "mmproj-F16.gguf")
...
# for KV cache at Q4_K_M; 131072 keeps that budget comfortable.
#
